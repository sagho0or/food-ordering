								...
								<div class="module-body table">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
										...
										<tbody>
											...
											<?php $query = mysqli_query($con, "SELECT p.*, c.categoryName AS categoryName FROM products p JOIN category c ON c.id = p.category");
											$cnt = 1;
											...
											?>
												<tr>
													...
													<td><?php echo htmlentities($row['cafeName']); ?></td>
