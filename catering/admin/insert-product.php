...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "insert into products(category,productName,cafeName,productPrice,productDescription,productAvailability,productImage1) values('$category','$productname','$cafeName','$productprice','$productdescription','$productavailability','$productimage1')");
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Cafe Name</label>
											<div class="controls">
												<input type="text" name="cafeName" placeholder="Enter Cafe Name" class="span8 tip" required>
											</div>
										</div>
