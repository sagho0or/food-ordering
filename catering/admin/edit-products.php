...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "update  products set category='$category',productName='$productname',cafeName='$cafeName',productPrice='$productprice',productAvailability='$productavailability' where id='$pid' ");
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="cafeName" placeholder="Enter Cafe Name" value="<?php echo htmlentities($row['cafeName']); ?>" class="span8 tip" required>
												</div>
											</div>
											<div class="control-group">
