	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-9 logo-holder">
				<div class="logo">
					<a href="index.php">
						<h2>Hull University Catering</h2>
					</a>
				</div>
			</div>
									...
									<li>
										<div class="cart-item product-summary">
											<div class="row">
												<div class="col-xs-4">
													<div class="image">
														<a href="product-details.php?pid=<?php echo $row['id']; ?>"><img src="admin/productimages/<?php echo $row['id']; ?>/<?php echo $row['productImage1']; ?>" width="40" height="30" alt=""></a>
													</div>
												</div>
												<div class="col-xs-7">
					...
					<div class="dropdown dropdown-cart">
						...
						<ul class="dropdown-menu">
							<li>
								...
								<div class="clearfix cart-total">
									<div class="clearfix"></div>
									<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Continue Ordering</a>
								</div>
							</li>
						</ul>
					</div>
