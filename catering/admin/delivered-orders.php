                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display table-responsive">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = mysqli_query($con, "SELECT orders.id AS orderId, orderDetails.productName AS productname, orderDetails.productQuantity AS quantity, orders.orderDate AS orderdate, orderDetails.productPrice AS productprice FROM orders JOIN orderDetails ON orderDetails.orderId=orders.orderId WHERE orders.orderStatus='$st' ORDER BY orders.id DESC");
                                            $orderData = [];
